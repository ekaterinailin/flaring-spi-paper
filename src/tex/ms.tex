...
In the scenario wherein the stretch-and-break mechanism drives the interaction, the three system cluster together most distinctly. In this scenario, most, but not all systems that do not show elevated interaction, have a weaker magnetic field~(top row in Figure\ref{fig:adtest_bp}). An excep

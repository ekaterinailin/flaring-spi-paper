...
\begin{figure*}[ht!]
    ...
    \begin{centering}
        \includegraphics[width=.9\linewidth]{figures/PAPER_flares_phase_hist_transiting.png}
        \caption{
...
\begin{figure*}[ht!]
    ...
    \begin{centering}
        \includegraphics[width=0.9\linewidth]{figures/PAPER_flares_phase_hist_rv.png}
        \caption{

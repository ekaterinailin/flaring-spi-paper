...
\begin{figure}[ht!]
    ...
    \begin{centering}
        ...
        \caption{
            Same as Fig.~\ref{fig:adtest_bp}, but for three other scenarios. \textbf{Top panel}: stretch-and-break scenario for an unmagnetized planet. \textbf{Middle panel}: Alfv\'en wing scenario, assuming a magnetized planet. \textbf{Bottom panel}: Alfv\'en wing scenario, assuming an unmagnetized planet. See Fig.~\ref{fig:adtest_ro} in the Appendix for the same figure, color-coded by Rossby number.
        }

...
HIP 67522 is a young Sun, currently contracting onto the main sequence. It is a Sco-Cen member (10-20 Myr old), which was discovered to host a close-in Jupiter, HIP 67522 b, in 2020~\citep{rizzuto2020tess}. Curiously, the planet is in close spin-orbit commensurability -- $P_{\rm rot}/P_{\rm orb}\approx 1/5$. Therefore, we cannot completely rule out that the observed periodicity is in fact a rotational periodicity, and not related to the planet. However, if we calculate the $p$-value of the AD test using the rotational period instead of the orbital period, we find HIP 67522 deviates from uniform flaring in time with $p=0.18$. So we cannot rule rotational modulation completely, since the rotational period is very uncertain relative to the total observing baseline, and the clustering close to transit is suggestive.% Fortunately, HIP 67522 will be observed again with TESS in April 2023, which may resolve the puzzle.
